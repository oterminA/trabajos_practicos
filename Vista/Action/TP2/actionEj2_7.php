...
//el action acá sirve como intermediario entre la vista y el controller (con un script php en el medio para poder mostrar el resultado en la vista(html))
    ...
    include_once('../../../Control/TP2/controlEj2_7.php');//para pasarle los datos al controller, que este haga las operaciones, las devuelva acá para pasarselas al mensaje.php
...
<!-- por alguna razon funciona y no funciona el css -->
    <div id="divMensaje">
        ...
        echo $mensaje;
        ?>
        <a href="../../TP2/ejercicio_2_7.php">volver a inicio</a>
    </div>
